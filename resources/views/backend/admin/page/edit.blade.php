                        ...
                        <form action="{{route('admin.pages.update', $page->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>{{__('Name')}}</label>
                                        <input name="name" placeholder="{{__('Name')}}" class="form-control" type="text" value="{{ $page->name }}" autocomplete="off" id="name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>{{__('Slug')}}</label>
                                        <input type="text" class="form-control" placeholder="{{__('Slug')}}" name="slug" value="{{$page->slug}}" required="" autocomplete="off" id="slug">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>{{__('Text')}}</label>
                                        <textarea name="text" class="form-control textarea" >{{$page->text}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="box box-success box-solid">
                                    ...
                                    <div class="box-body box-profile">
                                        <img class="profile-user-img img-responsive img-circle" src="{{asset($page->photo)}}" alt="Page Photo" id="page-photo">
