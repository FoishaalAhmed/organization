...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{route('colors.index')}}"><i class="fa fa-group"></i> Color</a></li>
        </ol>
    </section>
    <div class="content">
        <div class="row">
                ...
                <div class="box box-teal box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                        	<a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> New Color</a>
                        </div>		
                    </div>
                    <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>   
                                    	...
                                    	<a class="btn btn-sm bg-teal" href="#" data-toggle="modal" data-target="#edit-modal" data-id="{{$color->id}}" data-name="{{$color->name}}"><span class="glyphicon glyphicon-edit"></span></a>

                                    	<form action="{{route('colors.destroy',$color->id)}}" method="post" style="display: none;" id="delete-form-{{ $color->id}}">
                                            @csrf
                                            {{method_field('DELETE')}}
                                        </form>
                                        <a class="btn btn-sm bg-red" href="" onclick="if(confirm('Are You Sure To Delete?')){
                                            event.preventDefault();
                                            getElementById('delete-form-{{ $color->id}}').submit();
                                            }else{
                                            event.preventDefault();
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('colors.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
