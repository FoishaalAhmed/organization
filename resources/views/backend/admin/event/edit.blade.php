...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{__('Event Update')}}</li>
        </ol>
    </section>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-success box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('Event Update')}}</h3>
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{route('admin.events.update', $event->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="col-md-9">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input name="title" placeholder="{{__('Title')}}" class="form-control" type="text" value="{{ $event->title }}" autocomplete="off" id="name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>{{__('Slug')}}</label>
                                        <input type="text" class="form-control" placeholder="{{__('Slug')}}" name="slug" value="{{$event->slug}}" required="" autocomplete="off" id="slug">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>{{__('details')}}</label>
                                        <textarea name="details" class="form-control textarea" >{{$event->details}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="box box-success box-solid">
                                    ...
                                    <div class="box-body box-profile">
                                        <img class="profile-user-img img-responsive img-circle" src="{{asset($event->photo)}}" alt="Event Photo" id="page-photo">
